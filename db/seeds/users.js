  ...
  return knex('likes').del()
    ...
    .then(function () {
      return Promise.all([
        ...
        knex('categories').insert({picture_url: '../images/crafts.jpg' , name: 'crafts'}),
        knex('categories').insert({picture_url: './images/fitness.jpg' , name: 'fitness'}),
        ...
        knex('categories').insert({picture_url: './images/movies.jpg' , name: 'movies'}),
        knex('categories').insert({picture_url: './images/other.jpg' , name: 'other'}),
        knex('categories').insert({picture_url: '../images/sports.jpg' , name: 'sports'}),
        knex('categories').insert({picture_url: './images/technology.jpg' , name: 'technology'}),
        knex('categories').insert({picture_url: './images/travel.jpg' , name: 'travel'}),
      ]);
    // }).then(function () {
    //   return Promise.all([
